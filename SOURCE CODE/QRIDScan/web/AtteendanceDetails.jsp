...
<html lang="en">
    ...
    <body>
        ...
        %>
        <%
            String presentDates = request.getParameter("presentDates");
     //    if (presentDates != null) {
     //        String[] datesArray = presentDates.split(",");
     //        out.println("<h3>Present Dates:</h3>");
     //        for (String date : datesArray) {
     //            out.println("<p>" + date + "</p>");
     //        }
     //    } else {
     //        out.println("<p>No attendance records found for the selected month.</p>");
     //    }
        %> 
                    ...
                    <div class="col-md-12">
                        <center><div class="col-md-6" data-wow-delay="0.3s">
                                ...
                                <div class="row g-3">
                                    ...
                                    <label>Total Present Dates</label>
                                    <div class="col-12">
                                        <% if (presentDates != null && !presentDates.isEmpty()) { %>
                                        <table class="table table-bordered  bg-light px-4 border-primary">
                                            <thead>
                                                <tr>
                                                    <th>Date</th>
                                                </tr>
